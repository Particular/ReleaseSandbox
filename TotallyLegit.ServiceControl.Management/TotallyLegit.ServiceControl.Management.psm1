<#
    .Synopsis
    Lists the commands and aliases provided by the TotallyLegit.ServiceControl.Management module.

    .Description
    Lists the commands and aliases provided by the TotallyLegit.ServiceControl.Management module. This command is meant as a starting point as it lists what is available in the module.
#>
Function Get-ServiceControlManagementCommands {
    PROCESS {
        Get-Alias -Scope Global | Where-Object ModuleName -EQ "TotallyLegit.ServiceControl.Management" | Select-Object -Property @{Name = 'Alias'; Expression = {$_.Name}}, @{Name = 'Command'; Expression = {$_.Definition}}
    }
}
...
if ($PSVersionTable.Platform -ne 'Win32NT')
{
    ...
    throw "TotallyLegit.ServiceControl.Management is only supported on Windows."
}
