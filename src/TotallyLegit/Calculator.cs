...
public class Calculator
{
    ...
    public int Add(int nextNumber) => _result += nextNumber;
    ...
    /// <returns>The updated running total.</returns>
    public int Subtract(int nextNumber) => _result -= nextNumber;
    ...
    /// <returns>The updated running total.</returns>
    public int Multiply(int nextNumber) => _result *= nextNumber;
}
